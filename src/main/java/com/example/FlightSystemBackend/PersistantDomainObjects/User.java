...
public class User implements POCO{
    ...
    public String[] toStringArray() {
        String[] arr =  {"'%s'".formatted(username),"'%s'".formatted(password),
                             "'%s'".formatted(email),"%s".formatted(user_role),"%s".formatted(id)} ;
        return arr ;
    }
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return id == user.id && user_role == user.user_role && Objects.equals(username, user.username) && Objects.equals(password, user.password) && Objects.equals(email, user.email);
    }
